    ...
    return (
        <section className="flex flex-col sm:flex-row justify-center items-center w-full mt-[30px]">
            <div className="w-[90vw] sm:w-[35vw] md:w-[30vw] lg:w-[25vw]">
                <h2 className='text-[18px] sm:text-[20px] md:text-[30px]'>DSCubed IT projects</h2>
                <p className="text-[14px] sm:text-[16px] md:text-[18px] text-gray-500 mb-[15px]">UI Design | Front End</p>
