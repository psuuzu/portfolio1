    ...
    return (
        <section className="flex flex-col sm:flex-row justify-center items-center w-full mt-[30px]">
            ...
            <div className="w-[90vw] sm:w-[35vw] md:w-[30vw] lg:w-[25vw]">
                <h2 className='text-[20px] md:text-[30px]'>SurroundSound</h2>
                <p className="text-[16px] md:text-[18px] text-gray-500 mb-[15px]">UI Design | Hackathon</p>
                <p className="text-[14px] md:text-[16px] sm:ml-[10px]">SurroundSound is a project that won first place and accessibility award in the 2024 CISSA Catalyst Hackathon. Our team developed a working application that uses AI to curate personalized Spotify 
