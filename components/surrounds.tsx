    ...
    return (
        <section className="flex flex-col sm:flex-row justify-center items-center w-full mt-[30px]">
            ...
            <div className="w-[90vw] sm:w-[35vw] md:w-[30vw] lg:w-[25vw]">
                ...
                <p className="text-[12px] sm:text-[14px] md:text-[16px] sm:ml-[10px]">SurroundSound is a project that won first place and accessibility award in the 2024 CISSA Catalyst Hackathon. Our team developed a working application that uses AI to curate personalized Spotify 
