...
export default function Test() {
  ...
  let starbreak = "/images/creative/sb.png"
  ...
  if(sboriginal==true){
    ...
    starbreak = "/images/creative/sbo.png"
  }

  if(sboriginal==false){
    buttontext = "View Original"
    starbreak = "/images/creative/sb.png"
  }
  ...
  return (
    <section className='flex justify-center'>
        <div className='w-[90vw] sm:w-[70vw] md:w-[60vw] lg:w-[50vw] h-auto z-40 bg-black'> 
          ...
          <img src="/images/creative/game.jpg" alt="Game poster" className="rounded-xl"/>
