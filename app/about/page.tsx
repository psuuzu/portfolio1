        ...
        <section className="h-auto sm:h-[100vh] w-[100vw] flex flex-col justify-center items-center mt-[50px] sm:mt-0">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center">
                    ...
                    <div className="w-[80vw] sm:w-[42vw] lg:w-[30vw] flex flex-col">
                        ...
                        <p className="mt-[20px] hidden sm:block pr-[10px]">I’m a UX designer with a background in visual arts, passionate about creating intuitive solutions that are visually appealing and backed by research and testing. Beyond UX design, I am expanding my front end development skills in react to bring my designs to life</p>
