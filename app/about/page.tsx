        ...
        <section className="h-auto w-[100vw] flex flex-col items-center mt-[50px] sm:mt-[100px]">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center">
                    ...
                    <div className="w-[80vw] sm:w-[42vw] lg:w-[30vw] flex flex-col">
                        ...
                        <p className="mt-[20px] hidden sm:block pr-[10px]">I’m a UX designer with a passion for creating intuitive solutions that bridge the gap between people and technology—blending visual appeal with research and testing. Beyond UX design, I am trying to expand my front end development abilities in react to bring my designs to life.</p>
                    ...
                    <div className="w-[80vw] block sm:hidden">
                        <p className="mt-[20px] ">I’m a UX designer with a passion for creating intuitive solutions that bridge the gap between people and technology—blending visual appeal with research and testing. Beyond UX design, I am trying to expand my front end development abilities in react to bring my designs to life.</p>
