...
export default function Tap2heal() {
    return(
        <>
        <section className="h-[620px] sm:h-[97vh] flex-col flex "> 
            <div className="h-full w-full sm:w-auto flex-col flex sm:flex-row sm:ml-[5vw] md:ml-[10vw] lg:ml-[15vw] items-center relative"> 
                <div className="flex mt-[60px] sm:mt-0 z-10">
                    ...
                    <div className="ml-[10px] sm:ml-[30px]">
                        ...
                        <p className="text-[16px] w-auto sm:w-[180px] mt-[10px]">Usability evaluation</p>
                    </div>
                </div>                
                <div className="w-full sm:w-auto h-full mb-[60px] sm:mb-0 absolute z-0">
                    <img src="images/lab.jpg" alt="banner image" className="w-full h-full sm:w-auto sm:h-full object-contain "/>
                </div>
            </div> 
        </section>
